...
function coursePreviewVideo() {
  const coursePreviewVideoModal = document.querySelector('.js-course-preview-modal');
  if (coursePreviewVideoModal) {
    /* If the element exists */
    coursePreviewVideoModal.addEventListener('shown.bs.modal', function () {
      this.querySelector('.js-coures-preview-video').play();
      this.querySelector('.js-coures-preview-video').currentTime = 0;
    });

    coursePreviewVideoModal.addEventListener('hide.bs-modal', function () {
      this.querySelector('.js-coures-preview-video').pause();
    });
  }
}
coursePreviewVideo();
